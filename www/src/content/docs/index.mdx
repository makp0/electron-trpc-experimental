...
hero:
  ...
  actions:
    - text: Getting Started
      ...
      variant: primary
    - text: Example Usage
      link: https://github.com/makp0/electron-trpc/tree/main/examples/
      icon: external
---
...
{/* Using config values - these will be used when we convert frontmatter to use variables */}
{DOCS_CONFIG.title}
{DOCS_CONFIG.description}
{DOCS_CONFIG.tagline}
{DOCS_CONFIG.externalLinks.examplesUrl}
</div>
